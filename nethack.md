...
:   Используемый видеорежим (только для PC версий NetHack).
    ...
    Установка режима «`vga`» (или «`autodetect`» на оборудовании где
	есть VGA) изменит игру на использование тайлов.
...
:   Установка насыщенности трех шкал серого цвета (по умолчанию `dark normal light`).
    ...
    Если с игрового экрана сложно читать, попробуйте поменять эти шкалы.
	Если не поможет, попробуйте !color.
