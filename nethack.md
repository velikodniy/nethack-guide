...
Точный формат шаблона зависит от того, собрана ли текущая платформа с
регулярными выражениями или используется внутренний формат NetHack.

Регулярные выражения могут быть более гибкими, чем формат NetHack,
но требуют сторонних библиотек.

Существует великое многообразие информации, касаемой использования
регулярных выражений.

Вы можете выяснить, какой шаблон сравнения использует порт,
выполнив команду «`#version`».
...
В данном случае любое сообщение, содержащее «chime of a cash register» будет
воспроизводиться со звуком «gong.wav».

Вы можете использовать любое количество вхождений опции «`SOUND`»
...
возвращает текущий столбец и текущую строку курсора.
...
Замените файл `defaults.nh` этим файлом и игра будет настроена для
игры слепым человеком.

После того, как вы освоитесь в игре и в редактировании файлов, вы
сможете настроить игру наиболее удобным способом.
...
При компиляции NetHack также можно указать, какое количество записей
хранить.
...
руководства «A Guide to the Dungeons of Doom», написанного Michael C. Toy
и Kenneth C. R. C. Arnold.
...
Также именно в этой версии появилась возможность верховой езды, и
...
Alex Kompel также портировал игру на Windows CE.
...
Переведено на сайте [www.notabenoid.com](http://notabenoid.com/book/20643/67711).
(По состоянию на 2014-02-01.)
